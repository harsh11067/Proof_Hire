...
import CompleteApplicationFlow from "./components/CompleteApplicationFlow";
import TestApplicationPage from "./components/TestApplicationPage";
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="apply" element={<CompleteApplicationFlow jobTitle="Software Engineer" companyName="Tech Corp" />} />
        <Route path="test" element={<TestApplicationPage />} />
        <Route path="upload-test" element={<SimpleUploadTest />} />
